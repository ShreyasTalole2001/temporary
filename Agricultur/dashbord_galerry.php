...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
 ...
 $query = "DELETE FROM galerry WHERE Description='$ImageDes' LIMIT 1 ;";
...
<form action="upload_galerry.php" method="post" enctype="multipart/form-data" >
...
<form method="post"  >
      ...
      <div class="form-group">
        <label for="heading">Image Name</label>
        <input type="text" class="form-control" id="ImageDes" name="ImageDes" >
      </div>

      <div class="form-group">
        <input type="submit" class="form-control" name="submit" value="REMOVE" style="background-color:green;color: white;">
      </div>
