  	 ...
  	 <! Main Menu Bar !>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link actived" href="news.php"><b>बातम्या</b></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="boardmembers.php"><b>संचालक मंडळ</b></a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="#"><b>संपर्क</b></a>
            </li>
...
if ($result=mysqli_query($conn,$query)) {
  while ($row=mysqli_fetch_array($result)) {
          ...
          $postData = $row['Data'];
          $ImageURL ='uploads_blog/'.$row['Image'];
          $Datee=$row['datee'];
...
<div class='container' id='Blog_wrapper'>
    <div class='row'>
      <div class='col-lg-8 col-md-10 mx-auto'>
        <div class='post-preview' id='wrapper'>
