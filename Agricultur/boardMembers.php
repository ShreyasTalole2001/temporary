...
<div class="container" id="wrapper">
  <div class="row">
    <div class="col-sm col d-flex justify-content-center">

        <div class="card" style="width: 18rem;text-align: center;margin-top: 10px;">
          <img class="card-img-top" src="images/kolate.jpg" alt="Card image cap">
          <div class="card-body">
            <h5>डॉ.अरविंद कोलते</h5>
            <h6>मुख्य प्रशासक</h6>
          </div>
        </div>
    ...
    <div class="col-sm col d-flex justify-content-center">
       ...
       <div class="card" style="width: 18rem;text-align: center;margin-top: 10px;">
          <img class="card-img-top" src="images/61.jpg" alt="Card image cap">
          <div class="card-body">
            <h5>श्री.संतोषभाऊ साहेबराव रायपुरे</h5>
            <h6>उपमुख्य प्रशासक</h6>
          </div>
        </div>
