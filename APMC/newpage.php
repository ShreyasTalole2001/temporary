...
<h1 id="heading">UPDATE DATA HERE</h1>
...
<hr>
  ...
  <div class="form-row" style="position: relative;z-index: 10;">
    <div class="col">
      <input type="text" style="text-align: center;" class="form-control-plaintext" placeholder="जास्तीत जास्त ">
    </div>
    <div class="col">
      <input type="text" style="text-align: center;" class="form-control-plaintext" placeholder="कमीत कमी" >
    </div>
    <div class="col">
      <input type="text" style="text-align: center;" class="form-control-plaintext" placeholder="सरासरी" >
    </div>
    <div class="col">
      <input type="text" style="text-align: center;" class="form-control-plaintext" placeholder="आवक" >
    </div>
  </div>
<hr>   
	<! 1 !>
...
<div style="text-align: center;">
  <div class="form-row">
    <div class="col" >
      <input style="width: 50%; text-align: center;background-color: blue;color: white;" type="submit" class="btn btn-primary" value="Submit" >
    </div>
    </div>
</div> 
