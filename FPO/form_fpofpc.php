...
if (!empty($_POST) &&  $_SERVER['REQUEST_METHOD'] === 'POST') {
    $nameOfFpcFpo = mysqli_real_escape_string($LiveWebinar_Conn, $_POST['nameOfFpcFpo']);
    $address = mysqli_real_escape_string($LiveWebinar_Conn, $_POST['address']);
    $district = mysqli_real_escape_string($LiveWebinar_Conn, $_POST['district']);
    $state = mysqli_real_escape_string($LiveWebinar_Conn, $_POST['state']);
    $yearOfEstablishment = mysqli_real_escape_string($LiveWebinar_Conn, $_POST['yearOfEstablishment']);
    $listOfMajorCropsProducedByYourFpo = mysqli_real_escape_string($LiveWebinar_Conn, $_POST['listOfMajorCropsProducedByYourFpo']);
    ...
    $query = "INSERT INTO form_fpo_fpc (nameOfFpcFpo, address, district, state, yearOfEstablishment, listOfMajorCropsProducedByYourFpo, phoneNo, email, datee   ) 
    VALUES ('$nameOfFpcFpo', '$address','$district', '$state', '$yearOfEstablishment', '$listOfMajorCropsProducedByYourFpo', '$phoneNo', '$email', '$datee'  )";
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-5 formclass">
                ...
                <form method="post">
                    <h3 style="text-align: center;">FPO / FPC</h3>
                    ...
                    <div class="mb-3">
                        <label for="nameOfFpcFpo" class="form-label">Name Of FPC/FPO</label>
                        <input type="text" class="form-control" id="nameOfFpcFpo" name="nameOfFpcFpo" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="listOfMajorCropsProducedByYourFpo" class="form-label">List of Major Crops procured by your FPO</label>
                        <input type="text" class="form-control" id="listOfMajorCropsProducedByYourFpo" name="listOfMajorCropsProducedByYourFpo" required>
                    </div>
                    <div class="mb-3">
                        <label for="proceedFoodOrProducts" class="form-label">List of Processed Food/Products Produced by your FPO (if any) </label>
                        <input type="text" class="form-control" id="proceedFoodOrProducts" name="proceedFoodOrProducts" required>
                    </div>
                    <div class="mb-3">
